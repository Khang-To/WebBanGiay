...
$sql = "SELECT * FROM don_hang WHERE khach_hang_id = ? AND trang_thai = 'da_xac_nhan' ORDER BY ngay_dat DESC";
...
<div class="container py-5">
    <h2 class="mb-4 text-info"><i class="bi bi-credit-card me-2"></i>Có thể thanh toán</h2>

    <?php if (count($don_hangs) === 0): ?>
        <div class="alert alert-secondary text-white bg-dark"><i class="bi bi-info-circle-fill me-2"></i>Không có đơn hàng nào đang chờ thanh toán.</div>
    <?php else: ?>
